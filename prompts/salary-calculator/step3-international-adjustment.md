Using all salary data stored in Step 2, proceed with the international adjustment.
...
Save the full adjustment output to step3-adjustment-values.md in the workspace.
