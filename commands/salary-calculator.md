...
5. Ask me if I want to run the reality check. If I say yes: first, on your current model, draft the realistic career ladder for my profession as stated in profile.md — my field may be anything (do not assume software, tech, or any particular industry); infer the ladder from my actual profession and use that field's real progression and title conventions. Show it to me, and wait for my confirmation or edits — then save the confirmed ladder to sc-step5-career-ladder.md. This must happen before any handoff so the confirmation is not lost to a subagent. Then ask: "The reality check can also run on Claude Opus. Use Opus for this step? (yes/no)" — If I say yes, use the deep-reasoner subagent to read prompts/salary-calculator/step5-reality-check.md. If I say no, read it yourself and follow it exactly using your current model.
