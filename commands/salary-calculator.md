...
1. Read prompts/salary-calculator/step1-prompt.md and follow it exactly.
2. Read prompts/salary-calculator/step2-prompt.md and follow it exactly.
3. Read prompts/salary-calculator/step3-prompt.md and follow it exactly.
4. Read prompts/salary-calculator/step4-prompt.md and follow it exactly.
5. Ask me if I want to run prompts/salary-calculator/step5-prompt.md. Only run it if I say yes.
