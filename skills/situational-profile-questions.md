---
name: Situational Profile Questions
description: Shared questions that collect the candidate's location, citizenship, language, existing work authorization, and salary minimum into situational-profile.md. Reuses the file if it already exists; asks and saves if it does not.
---
